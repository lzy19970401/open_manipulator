...
#
# OpenMANIPULATOR-X Pinocchio gravity compensation control mode launch.
#
# Parallel to open_manipulator_x_gravity_compensation.launch.py (KDL backend).
# Mutually exclusive with Standard control launch and the KDL GC launch.
#
...
#   ros2 launch open_manipulator_bringup open_manipulator_x_pinocchio_gravity_compensation.launch.py use_mock_hardware:=true
#
...
def generate_launch_description():
    ...
    controller_manager_config = PathJoinSubstitution([
        ...
        'config',
        'open_manipulator_x_compensation_pinocchio',
