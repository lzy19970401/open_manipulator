...
#
# OpenMANIPULATOR-X Pinocchio joint-space impedance control mode launch.
#
# Mutually exclusive with Standard control launch, GC launches, and other effort modes.
#
# Hardware (or mock hardware CI smoke):
#   ros2 launch open_manipulator_bringup open_manipulator_x_pinocchio_impedance.launch.py
#   ros2 launch open_manipulator_bringup open_manipulator_x_pinocchio_impedance.launch.py use_mock_hardware:=true
#
...
def generate_launch_description():
    declared_arguments = [
        ...
        DeclareLaunchArgument(
            ...
            description='capture_on_activate or fixed (uses fixed_reference_positions in yaml).',
        ),
        DeclareLaunchArgument(
            'enable_friction_compensation',
            default_value='true',
            description='Enable Fv/Fc friction overlay on Arm joints.',
        ),
    ]
    ...
    reference_pose_mode = LaunchConfiguration('reference_pose_mode')
    ...
    controller_manager_config = PathJoinSubstitution([
        ...
        'config',
        'open_manipulator_x_impedance_pinocchio',
    ...
    control_node = Node(
        ...
        parameters=[
            ...
            {
                'pinocchio_impedance_controller': {
                    'ros__parameters': {
