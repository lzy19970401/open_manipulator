...
#
# OpenMANIPULATOR-X Gravity compensation control mode — Gazebo simulation.
#
...
#
# Hardware entry point (same GC controller yaml, effort ros2_control variant):
...
def generate_launch_description():
    ...
    doc = xacro.process_file(
        ...
        mappings={
            ...
            'config_type': 'open_manipulator_x_gc',
    ...
    return LaunchDescription([
        ...
        RegisterEventHandler(
            event_handler=OnProcessExit(
                ...
                on_exit=[gravity_compensation_controller_spawner],
            )
        ),
        bridge,
