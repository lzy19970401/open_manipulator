...
#
# OpenMANIPULATOR-X Pinocchio joint-space impedance control mode — Gazebo simulation.
#
# Mutually exclusive with Standard control Gazebo launch
# (open_manipulator_x_gazebo.launch.py): do not run both at once.
#
# Usage:
#   ros2 launch open_manipulator_bringup open_manipulator_x_pinocchio_impedance_gazebo.launch.py
#
...
def generate_launch_description():
    ...
    doc = xacro.process_file(
        ...
        mappings={
            ...
            'config_type': 'open_manipulator_x_impedance_pinocchio',
